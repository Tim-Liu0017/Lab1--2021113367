...
public class Tree {
    TreeNode head;
    public TreeNodeList<TreeNode> treeNodes;
    ...
    public TreeNodeList<TreeNode> getTreeNodes() {
    ...
    public String generateNewText(String inputText) {
        ...
        String wordsStr = Main.replaceStr(inputText);
        String[] words = Main.wordSplit(wordsStr);
    ...
    public String calcShortestPath(String word1, String word2, PathGraphAssist pga) throws CloneNotSupportedException {
        ...
        if (certainPaths.size() != 0) {
            ...
            for (int i = 0; i < certainPaths.size(); i++) {
                ...
                //res += endNode.getWord() + ".\n";
                // 修改这里，添加路径长度信息
                res += endNode.getWord() + " (length: " + certainPaths.get(i).pathLength + ").\n";
            }
        } else {
            // 不存在的
